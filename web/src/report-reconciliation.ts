...
export type ReplayedPublicValues = { decisionDigest: string; severity: string; rewardTier: string; ciphertextDigest?: string; patchCommitment?: string };
