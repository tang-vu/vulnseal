...
| Release quality | Dependency-ordered build before typechecks/tests; rebuilt from no workspace dist artifacts; production dependency audit clean on September 9; local key/ZKIR inventory inspected; bounded browser worker configuration | Fresh GitHub CI run, public production artifact/hosting verification, repeated network checks at release and native-wallet verification |
