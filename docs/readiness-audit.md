...
| Multiple reports and program discovery | Role vault retains up to 100 prepared/received reports for one program; backup/restore and selection preserve prior ownership material; demo still has one slot | Automatic encrypted persistence, multi-program selection and durable per-report transaction/private-note histories |
