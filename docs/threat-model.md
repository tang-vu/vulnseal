...
| Reintroduction after removal | Restores an older backup or reuploads a removed blob | Optional operator-owned retirement snapshot blocks listed HTTP uploads/reads and rejects restores containing listed digests; offline logical removal has a policy-bound preview/apply CLI and private audit | Missing/omitted policy on other services, outdated snapshots and independent copies; registry administration and physical-erasure validation remain absent; see [retention policy](ciphertext-retention.md) |
